...
/*ORDER BY And DESC is utilized to extract the max value*/
/*Deaths*/
SELECT 
(CASE 
...
/*Sum hospitlaizations for a given state*/
...
/*Sum the total tests for a given state*/
SELECT State_To_Code.State_Name, 
(CASE 
...
/*Sum the total deaths per state*/
SELECT State_To_Code.State_Name, 
(CASE 
